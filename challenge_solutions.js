...
var Car = function(make, model, year, location, actualPrice, priceMarkup){
	...
	// COUNT OPTION 1 (NOT AS GOOD, and see 2nd part after contructor)
	// the carCount CAN'T just be stored in the constructor,
	// because it needs to change every time a new car is created.
	// We could store it on the prototype, and we'd need to 
	// update it in the constructor in order to keep track
	...
	// a constructor is just a function, and JS functions are all objects 
